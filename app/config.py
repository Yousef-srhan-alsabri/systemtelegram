...
class Config:
    ...
    JOIN_INSPECT_DELAY_MIN_SECONDS = int(os.getenv("JOIN_INSPECT_DELAY_MIN_SECONDS", "2"))
    JOIN_INSPECT_DELAY_MAX_SECONDS = int(os.getenv("JOIN_INSPECT_DELAY_MAX_SECONDS", "4"))
